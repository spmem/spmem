...
class CogVideoXImageToVideoPipelineTracking(CogVideoXImageToVideoPipeline, DiffusionPipeline):
    ...
    def prepare_condlatents(
        ...
        print("video xxx:", video.shape, video.min(), video.max())
        ...
        print("prepare_condlatents - video_latents2:", video_latents.shape)
        ...
        print("cond_frames_t 0:", cond_frames_t)
        print("video_latents 0:", video_latents.shape[1])
