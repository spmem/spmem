...
def render_mesh(vertices, faces, vertex_features, H, W, camera, blur_radius=0.0, faces_per_pixel=1):
    """
    ...
    raster_settings = RasterizationSettings(
        ...
        max_faces_per_bin=max_faces_num,
        # bin_size=0,
    ...
    return images[0].permute(2, 0, 1), mask
