...
def _get_validation_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        '--validation_dir', 
        nargs='+', 
        default=["validation/000000000000.4_001", "validation/000000000017.3_025", "validation/000000000236.2_038"],
        help='Enter a list of validation_dir name'
    )    

    parser.add_argument(
        "--validation_prompt",
        type=str,
        default="The spider-man is walking through a busy city street at night.",
...
def _get_training_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="num of conditon frames for generation",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="num of reference frames for generation",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help="interval of ref attention",
    )
